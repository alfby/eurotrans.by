...
{	
	...
	public $defaultFrontTicketCurrency = 'BusReservation_Front_Ticket_Currency';
	...
	public function beforeFilter()
	{
		...
		if (!isset($_SESSION[$this->defaultFrontTicketCurrency])) {
			$_SESSION[$this->defaultFrontTicketCurrency] = 'BYN';
		}
	}
