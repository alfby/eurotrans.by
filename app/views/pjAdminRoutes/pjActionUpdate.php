			...
			<div id="bs_location_list" class="bs-location-list">
				...
				if(isset($tpl['arr']['city']) && count($tpl['arr']['city']) > 0)
				{
					...
					foreach($city_id_arr as $k => $city_id)
					{
						...
						$route_stop = isset($tpl['arr']['route_stop'][$city_id]) ? $tpl['arr']['route_stop'][$city_id] : array();
						?>
						<div class="<?php echo $tpl['cnt_bookings'] == 0 ? 'bs-location-row' : null;?>" data-index="<?php echo $index;?>">
							<p>
								...
								<span class="inline_block">
									<select name="city_id_<?php echo $index;?>" class="pj-form-field w200 required bs-city"<?php echo $tpl['cnt_bookings'] > 0 ? ' disabled="disabled"' : null;?>>
								...
								<span class="inline_block l10 r10">
									<?php __('lblDeparture');?> <input type="checkbox" name="is_departure_<?php echo $index;?>" value="1" <?php echo (int)@$route_stop['is_departure'] == 1 ? 'checked="checked"' : null;?> />
								</span>
								<span class="inline_block r10">
									<?php __('lblArrival');?> <input type="checkbox" name="is_arrival_<?php echo $index;?>" value="1" <?php echo (int)@$route_stop['is_arrival'] == 1 ? 'checked="checked"' : null;?> />
								</span>
                                                                <!--
								<span class="inline_block">
									<?php __('lblExcludeFromSearch');?> <input type="checkbox" name="exclude_from_search_<?php echo $index;?>" value="1" <?php echo (int)@$route_stop['exclude_from_search'] == 1 ? 'checked="checked"' : null;?> />
								</span>
                                                                -->
							</p>
					...
					<div class="<?php echo $tpl['cnt_bookings'] == 0 ? 'bs-location-row' : null;?>" data-index="<?php echo $index;?>">
						<p>
							...
							<span class="inline_block">
								<select name="city_id_<?php echo $index;?>" class="pj-form-field w200 required bs-city">
									<option value="">-- <?php __('lblChoose'); ?>--</option>
									<?php
							...
							<span class="inline_block l10 r10">
								<?php __('lblDeparture');?> <input type="checkbox" name="is_departure_<?php echo $index;?>" value="1" />
							</span>
							<span class="inline_block">
								<?php __('lblArrival');?> <input type="checkbox" name="is_arrival_<?php echo $index;?>" value="1" />
							</span>
                                                        <!--
							<span class="inline_block">
								<?php __('lblExcludeFromSearch');?> <input type="checkbox" name="exclude_from_search_<?php echo $index;?>" value="1" />
							</span>
                                                        -->
						</p>
						<div class="location-icons">
	...
	<div id="bs_location_clone" style="display:none;">
		<div class="bs-location-row" data-index="{INDEX}">
			<p>
				...
				<span class="inline_block">
					<select name="city_id_{INDEX}" class="pj-form-field w200 required bs-city">
						<option value="">-- <?php __('lblChoose'); ?>--</option>
						<?php
						foreach($tpl['city_arr'] as $k => $v)
						{
				...
				<span class="inline_block l10 r10">
					<?php __('lblDeparture');?> <input type="checkbox" name="is_departure_{INDEX}" value="1" />
				</span>
				<span class="inline_block">
					<?php __('lblArrival');?> <input type="checkbox" name="is_arrival_{INDEX}" value="1" />
				</span>
                                <!--
				<span class="inline_block">
					<?php __('lblExcludeFromSearch');?> <input type="checkbox" name="exclude_from_search_{INDEX}" value="1" />
				</span>
                                -->
			</p>
			<div class="location-icons">
