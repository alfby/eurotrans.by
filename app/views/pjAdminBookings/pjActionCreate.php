		...
		<div id="tabs">
			...
			<div id="tabs-1">
				<div class="bs-loader-outer">
					...
					<p>
						<label class="title"><?php __('lblCurrency'); ?>:</label>
						<span class="inline-block">
							<select name="currency" id="currency" class="pj-form-field w200 required">
								<?php
								foreach($controller->defaultTicketCurrencies as $k => $v)
								{
									?><option value="<?php echo $k;?>"><?php echo pjSanitize::clean($k);?></option><?php
								} 
								?>
							</select>
						</span>
								...
								<span class="block overflow">
									...
									foreach($tpl['ticket_arr'] as $v)
									{
										...
										<span class="block b5 overflow">
											...
											<label class="block float_left t5"><?php echo pjUtil::formatCurrencySign( $v['price'], $currency);?></label>
										</span>
										<?php
									} 
									?>
					...
					<p>
						...
						<span class="pj-form-field-custom pj-form-field-custom-before">
							<span class="pj-form-field-before"><abbr class="pj-form-field-icon-text"><?php echo pjUtil::formatCurrencySign(NULL, $currency, ""); ?></abbr></span>
