...
class pjBookingModel extends pjAppModel
{
	...
	protected $schema = array(
		...
		array('name' => 'is_transfer', 'type' => 'tinyint', 'default' => '0'),
		array('name' => 'transfer_booking_id', 'type' => 'int', 'default' => ':NULL')
	);
	...
	public static function factory($attr=array())
	{
        ...
        public function linkBooking($id_before_transfer,$id_after_transfer){
            $this
                ->reset()
                ->set('id',$id_before_transfer)
                ->modify(array('is_transfer' => 1,'transfer_booking_id' => $id_after_transfer));

            $this
                ->reset()
                ->set('id', $id_after_transfer)
                ->modify(array('is_transfer' => 1,'transfer_booking_id' => $id_before_transfer));
